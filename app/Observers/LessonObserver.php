...
class LessonObserver
{
    ...
    // Este metodo vigilará que si eliminamos una lección no queden registros en la base de datos ni archivos en las carpetas
    public function deleting(Lesson $lesson){
        if($lesson->resource){
           ...
           Storage::delete($lesson->resource->url);
            //Y este codigo elima el registro de la base de datos cuando eliminamos una lección
