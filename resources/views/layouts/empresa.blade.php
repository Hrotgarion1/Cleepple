    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100">
            ...
            <div class="container py-8 grid grid-cols-5">
                ...
                <aside>
                    <h1 class="font-bold text-lg mb-4">{{ __('Mi empresa')}}</h1>
