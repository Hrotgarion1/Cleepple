<div class="form-group">
    ...
    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Nombre de la especialización']) !!}
    @error('name')
...
{{-- <div class="form-group">
    ...
    {!! Form::text('slug', null, ['class' => 'form-control', 'placeholder', 'readonly' => 'Slug de la especialización']) !!}
    @error('slug')
        <span class="text-danger text-sm">{{$message}}</span>
    @enderror
</div> --}}
...
<div class="form-group">
    {!! Form::label('profesion_id', 'Id de la profesion') !!}
    {!! Form::text('profesion_id', null, ['class' => 'form-control', 'placeholder' => 'Número de Id de la profesión']) !!}
    @error('profesion_id')
        <span class="text-danger text-sm">{{$message}}</span>
    @enderror
</div>
...
<div class="form-group">
    ...
    {!! Form::text('extract', null, ['class' => 'form-control', 'placeholder' => 'Extracto de la especialización']) !!}
    @error('extract')
        <span class="text-danger text-sm">{{$message}}</span>
    @enderror
</div>