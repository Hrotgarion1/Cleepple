...
<h1>{{ __('Editar Categoría del curso')}}</h1>
@stop
...
<div class="card">
    <div class="card-body">
     ...
     {{-- Para que el campo input traiga ya los datos que quiero actualizar, en lugar de form::open pongo form::model 
        ...
        {!! Form::model($categorycourse, ['route' => ['admin.categorycourses.update', $categorycourse], 'method' => 'put']) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::label('value', 'Valor en Eps') !!}
            {!! Form::text('value', null, ['class' => 'form-control', 'placeholder' => 'Valor en Eps de la categoría']) !!}
