...
<h1>{{ __('Crear nueva categoría para el curso')}}</h1>
@stop
...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            {!! Form::open(['route' => 'admin.categorycourses.store']) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::text('value', null, ['class' => 'form-control', 'placeholder' => 'Valor en Eps para la categoría']) !!}
