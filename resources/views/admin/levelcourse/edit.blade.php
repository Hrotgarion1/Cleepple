...
<h1>{{ __('Editar Nivel del curso')}}</h1>
@stop
...
<div class="card">
    <div class="card-body">
     ...
     {{-- Para que el campo input traiga ya los datos que quiero actualizar, en lugar de form::open pongo form::model 
        ...
        {!! Form::model($levelcourse, ['route' => ['admin.levelcourses.update', $levelcourse], 'method' => 'put']) !!}
        ...
        {!! Form::submit('Actualizar el nivel', ['class' => 'btn btn-primary btn-sm']) !!}
