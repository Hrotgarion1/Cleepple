...
<div class="card">
    <div class="card-body">
     ...
     {{-- Para que el campo input traiga ya los datos que quiero actualizar, en lugar de form::open pongo form::model 
        ...
        {!! Form::model($profesion, ['route' => ['admin.profesiones.update', $profesion], 'method' => 'put']) !!}

           @include('admin.profesiones.partials.form')

        {!! Form::submit('Actualizar la profesión', ['class' => 'btn btn-primary btn-sm']) !!}
