...
<body>
    ...
    <h1>{{ __('Verificación de curso rechazada')}}</h1>
    <h2 class="text-gray-600 font-bold text-base">{{ __('Nombre del curso:')}}</h2>
    <strong class="text-gray-500 text-base">{{$course->title}}</strong>
    <h2>Motivo de rechazo:</h2>
    <p>{!!$course->observationCourse->body!!}</p>
