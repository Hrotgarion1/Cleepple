<section>
    <h1 class="text-2xl font-bold">{{ __('AUDIENCIA DEL CURSO')}}</h1>
    <hr class="mt-2 mb-6">
    ...
    <article class="card">
        <div class="card-body bg-gray-100">
            ...
            <form wire:submit.prevent="store">
                ...
                <input wire:model="name" class="form-input w-full" placeholder="{{ __('Añadir la audiencia del curso')}}">
                ...
                <div class="flex justify-end mt-2">
                    <button type="submit" class="btn btn-primary">{{ __('Agregar audiencia')}}</button>
                </div>
            </form>
        </div>
    </article>
