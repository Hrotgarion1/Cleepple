...
class AccisolidFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = Accisolid::class;
    ...
    public function definition()
    {
        return [
            ...
            'status' => $this->faker->randomElement([Accisolid::PROPUESTO, Accisolid::REVISION, Accisolid::VERIFICADO, Accisolid::DENEGADO]),
            ...
            'clasaccion_id' => Clasaccion::all()->random()->id,
